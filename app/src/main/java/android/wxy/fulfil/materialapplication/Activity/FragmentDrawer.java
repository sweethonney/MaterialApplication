...
import android.wxy.fulfil.materialapplication.Adapter.NavigationDrawerAdapter;
import android.wxy.fulfil.materialapplication.Model.NavDrawerItem;
...
public class FragmentDrawer extends Fragment {
    ...
    public static FragmentDrawer newInstance(int index) {
